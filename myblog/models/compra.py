...
class Compra(db.Model):
    ...
    nitter = db.Column(db.Integer,db.ForeignKey('terceros.nitter'),default="")
    nomter = db.Column(db.Integer,default="")
    dirter = db.Column(db.Integer,default="")
    telter = db.Column(db.Integer,default="")
    corele = db.Column(db.Integer,default="")    
    ...
    def __init__(self, numcom, precom, docext, feccom, vencom, nitter, nomter, dirter, 
                telter, corele, subcom,totiva, totcom, estcom, codemp, horcom, obscom, 
                codclas, forpag, totdct, totaju) -> str:
        self.numcom = numcom
        self.nomdoc = "COMPRA"
        self.precom = ""
        self.docext = docext
